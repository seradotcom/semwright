...
SEMWRIGHT_TEST_PIPEWIRE_NODE=$(sed -n 's/^SEMWRIGHT_TEST_PIPEWIRE_NODE=//p' "$TARGET")
SEMWRIGHT_TEST_PIPEWIRE_SERIAL=$(sed -n 's/^SEMWRIGHT_TEST_PIPEWIRE_SERIAL=//p' "$TARGET")
[[ "$SEMWRIGHT_TEST_PIPEWIRE_NODE" =~ ^[0-9]+$ ]]
[[ "$SEMWRIGHT_TEST_PIPEWIRE_SERIAL" =~ ^[0-9]+$ ]]
