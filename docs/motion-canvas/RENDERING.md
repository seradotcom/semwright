...
4. Rust verifies SHA-256 pins for Node, `render.mjs` and a fixed-name `semwright-chromium` copy of the exact Playwright full Chromium executable kept beside its distribution resources.
